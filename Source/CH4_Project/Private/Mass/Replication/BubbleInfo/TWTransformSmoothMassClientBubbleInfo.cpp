...
ATWTransformSmoothMassClientBubbleInfo::ATWTransformSmoothMassClientBubbleInfo(
...
void ATWTransformSmoothMassClientBubbleInfo::GetLifetimeReplicatedProps(
	TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	...
	DOREPLIFETIME_WITH_PARAMS_FAST(ATWTransformSmoothMassClientBubbleInfo, BubbleSerializer, SharedParams);
}
