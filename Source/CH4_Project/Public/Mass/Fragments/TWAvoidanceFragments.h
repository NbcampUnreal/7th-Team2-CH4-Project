...
#include "TWAvoidanceFragments.generated.h"

USTRUCT()
struct FTWMovingAvoidanceParameters : public FMassConstSharedFragment
{
	GENERATED_BODY()

	FTWMovingAvoidanceParameters GetValidated() const
	{
		FTWMovingAvoidanceParameters Copy = *this;
...
USTRUCT()
struct FTWStandingAvoidanceParameters : public FMassConstSharedFragment
{
	GENERATED_BODY()

	FTWStandingAvoidanceParameters GetValidated() const
	{
		FTWStandingAvoidanceParameters Copy = *this;
...
/** Edge with normal */
struct FTWNavigationAvoidanceEdge
{
	FTWNavigationAvoidanceEdge(const FVector InStart, const FVector InEnd)
	{
		Start = InStart;
		End = InEnd;
...
USTRUCT()
struct FTWNavigationEdgesFragment : public FMassFragment
{
	GENERATED_BODY()

	static constexpr int MaxEdgesCount = 16;
	TArray<FTWNavigationAvoidanceEdge, TFixedAllocator<MaxEdgesCount>> AvoidanceEdges;
...
USTRUCT()
struct FTWAvoidanceEntitiesToIgnoreFragment : public FMassFragment
{
	GENERATED_BODY()
