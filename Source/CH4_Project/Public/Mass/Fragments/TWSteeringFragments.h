...
#include "TWSteeringFragments.generated.h"

class UWorld;

/** Steering fragment. */
USTRUCT()
struct FTWSteeringFragment : public FMassFragment
{
	GENERATED_BODY()
...
/** Standing steering. */
USTRUCT()
struct FTWStandingSteeringFragment : public FMassFragment
{
	GENERATED_BODY()
...
USTRUCT()
struct FTWMovingSteeringParameters : public FMassConstSharedFragment
{
	GENERATED_BODY()
...
USTRUCT()
struct FTWStandingSteeringParameters : public FMassConstSharedFragment
{
	GENERATED_BODY()
