...
#include "TWTransformOffsetParams.generated.h"

/**
 * 
 */
USTRUCT()  
struct CH4_PROJECT_API FTWTransformOffsetParams : public FMassConstSharedFragment  
{  
	GENERATED_BODY()  
...
public:  
	...
	FTWTransformOffsetParams GetValidated() const
	{  
		FTWTransformOffsetParams Params = *this;  
